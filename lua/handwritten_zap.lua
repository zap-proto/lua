...
local write_struct_field= zap.write_struct_field
local read_struct_field = zap.read_struct_field
local read_text         = zap.read_text
local write_text        = zap.write_text
local get_enum_val      = zap.get_enum_val
local get_enum_name     = zap.get_enum_name
...
local read_struct_buf   = zap.read_struct_buf
local read_listp_struct = zap.read_listp_struct
local read_list_data    = zap.read_list_data
local write_list        = zap.write_list
local write_list_data   = zap.write_list_data
...
_M.T1 = {
    ...
    displayName = "proto/example.zap:T1",
    dataWordCount = 6,
    pointerCount = 8,
    discriminantCount = 3,
...
_M.T1.T2 = {
    ...
    displayName = "proto/example.zap:T1.T2",
    dataWordCount = 2,
    pointerCount = 1,
    discriminantCount = 0,
...
_M.T1.g0 = {
    ...
    displayName = "proto/example.zap:T1.g0",
    dataWordCount = 6,
    pointerCount = 8,
    discriminantCount = 0,
    discriminantOffset = 0,
...
_M.T1.u0 = {
    ...
    displayName = "proto/example.zap:T1.u0",
    dataWordCount = 6,
    pointerCount = 8,
    discriminantCount = 4,
...
_M.T1.u0.ug0 = {
    ...
    displayName = "proto/example.zap:T1.u0.ug0",
    dataWordCount = 6,
    pointerCount = 8,
    discriminantCount = 0,
    discriminantOffset = 0,
...
_M.S1 = {
    ...
    displayName = "proto/struct.zap:S1",
    dataWordCount = 0,
    pointerCount = 1,
    discriminantCount = 0,
    discriminantOffset = 0,
